...
export const SecuritySvg = (props: ComponentProps<"svg">) => {
  return (
    <svg {...props} fill="#ffffff" height="24px" width="24px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 214.27 214.27">
